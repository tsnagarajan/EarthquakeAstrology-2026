  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="text-sm text-gray-700 space-y-3">
        ...
        <p>
          An XGBoost classifier was trained on data from 1900–2010 and evaluated on a held-out
          period of 2010–2026, ensuring no temporal data leakage. The decision threshold was
          chosen to maximize the Matthews Correlation Coefficient (MCC) on the holdout set.
          Predictions for 2026 were generated by applying the trained model to feature rows
          constructed from forward-projected planetary positions.
        </p>
      </div>

      <p className="text-xs text-gray-500 mt-8 mb-2">
        Evaluation results on 2010–2026 holdout set (XGBClassifier)
      </p>
      ...
      <h2 className="text-sm font-semibold text-gray-800 mt-8 mb-2">
        Confusion Matrix (2010–2026 Holdout)
      </h2>
